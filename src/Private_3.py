...
SECRET_SOURCE = os.environ.get("SECRET_SOURCE_3", "").strip()
CLASH_TEMPLATE = os.path.join(REPO_ROOT, "ClashTemplate.ini")
TEMP_FILE = "/tmp/temp3.yaml"
TEXTDB_API = os.environ.get("TEXTDB_API_3", "").strip()
...
def build_name(flag, cc, index, ipv6_tag=False):
    ...
    return f"{flag} {cc}-{index}{suffix} | PrivateSub_3"
